...
public class FormView extends JDialog{
    private JLabel titreLabel, auteurLabel, resumeLabel, parutionLabel, rangeeLabel, colonneLabel, statusLabel, aQuiLabel;
    private JTextField titre, auteurPrenom, auteurNom, parution, rangee, colonne, aQui;
    ...
    private Font font;
    private JButton appliquer, fermer;

    public FormView(JFrame parent, String titreForm) {
        ...
        panForm = new JPanel();
        panForm.setPreferredSize(new Dimension(400, 500));
